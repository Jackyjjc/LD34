...
public class GameManager : MonoBehaviour {
    ...
    void Update () {
        ...
        /*if (player.actionPointLeft == 0) {
            growUpButton.GetComponentInChildren<Text>().text = "Grow up";
            growUpButton.GetComponent<Button>().interactable = true;
        } else
        {
            growUpButton.GetComponentInChildren<Text>().text = (player.actionPoint - player.actionPointLeft) + " / " + player.actionPoint;
            growUpButton.GetComponent<Button>().interactable = false;
        }*/
